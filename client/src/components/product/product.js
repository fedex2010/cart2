            ...
            */}
            <div className="cart-item card"  itemscope itemtype="http://schema.org/Product">
                <div className="cart-item-detail" itemscope itemtype="http://schema.org/Offer">
                    <div className="cart-item-column">
                        ...
                        <img src="https://via.placeholder.com/65x65" alt="product name"  itemProp="image"/>
                        </picture>
                    </div>
                    <div className="cart-item-column cart-item-column-lg">
                        <h3 className="cart-item-name"><a href="#" title="" itemprop="url">Aire Acondicionado Split Philco 2236 Fg 2600 W ire Acondicionado Split Philco 2236 Fg 2600 W</a></h3>
                        <span className="cart-item-tag cart-item-tag--error">Agotado</span>
                        <span className="cart-item-tag cart-item-tag--success">Bonificación aplicada</span>
                    </div>
                    <div className="cart-item-column">
                        <label>Precio:</label>
            ...
            <div className="cart-item card" itemscope itemtype="http://schema.org/Product">
                <div className="cart-item-detail" itemscope itemtype="http://schema.org/Offer">
                    <div className="cart-item-column">
                        <picture className="cart-item-image">
                        <img src="https://d3lfzbr90tctqz.cloudfront.net/epi/resource/l/garantia-extendida/033335bd1fed9313f2feffb2b74890a79be791f3ff9ace2b2c6eafa535a5ee8f" alt="product name"  itemProp="image"/>
                        </picture>
                    </div>
                    <div className="cart-item-column cart-item-column-lg">
                        <h3 className="cart-item-name">Garantía de reparación por <strong>24 meses</strong>
            ...
            <div className="cart-item card cart-item--vta-empresas" itemscope itemtype="http://schema.org/Product">
                <div className="cart-item-detail" itemscope itemtype="http://schema.org/Offer">
                    ...
                    <div className="cart-item-column cart-item-column-lg">
                        <h3 className="cart-item-name"><a href="#" title="" itemprop="url">Aire Acondicionado Split </a></h3>
                    </div>
                    <div className="cart-item-column">
                        <label>Precio:</label>
            ...
            <div className="cart-item card cart-item--vta-empresas card--is-loading" itemscope itemtype="http://schema.org/Product">
                <div className="cart-item-detail" itemscope itemtype="http://schema.org/Offer">
                    ...
                    <div className="cart-item-column cart-item-column-lg">
                        <h3 className="cart-item-name"><a href="#" title="" itemprop="url">Aire Acondicionado Split Aire Acondicionado Split Aire Acondicionado SplitAire Acondicionado SplitAire Acondicionado Split</a></h3>
                    </div>
                    <div className="cart-item-column">
                        <label>Precio:</label>
            ...
            <div className="cart-item card cart-item-sold-out" itemscope itemtype="http://schema.org/Product">
                <div className="cart-item-detail" itemscope itemtype="http://schema.org/Offer">
                    ...
                    <div className="cart-item-column cart-item-column-lg">
                        <h3 className="cart-item-name"><a href="#" title="" itemprop="url">Aire Acondicionado Ventana Surrey Frio 3010 Fg 3500 W UCVE12</a></h3>
                        <span className="cart-item-tag cart-item-tag--error">Agotado</span>
                    </div>
                    <a className="has-tooltip gui-icon-trash icon--md">
                        <span className="tooltip_bottomCenter">Eliminar</span> 
