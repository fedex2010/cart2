  ...
  render() {
    return (
      <div>
        ...
        <div
          id="warranty-modal"
          className="gui-modal fade warrantyToggle"
          tabIndex="-1"
          role="dialog"
        >
          <div className="gui-modal-dialog gui-modal-md">
            ...
            <div className="gui-modal-content" id="warranty-info">
              <div className="gui-modal-header gui-modal-header--has-border">
                ...
                <a
                  ...
                  onClick={this._termsAndConditions}
                  data-target="#show-warranties-tyc"
                >
            ...
            {/* info TyC */}
            <div className="gui-modal-content hide" id="show-warranties-tyc">
              <div className="gui-modal-header gui-modal-header--has-border">
      ...
      {/* MODAL GATANTIAS show-warranties-tyc*/}
      <div
