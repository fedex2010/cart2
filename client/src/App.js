      ...
      <div className="wrapper">
         <section>      
            ...
            <div className="feedback feedback-error feedback-dismissible">
               ...
               <p>El producto seleccionado está agotado. Eliminalo para poder continuar.</p>
            </div>

            <div className="feedback feedback-error feedback-dismissible">
               <button type="button" className="feedback--btn-close"></button>
               <p><strong>Atención!</strong> No es posible comprar estos productos en el mismo carrito.<br/>
               Te sugerimos comprarlos por separado así podemos ofrecerte más opciones de entrega.</p>
            </div>
            ...
            <div className="feedback feedback-success feedback-dismissible">
               <button type="button" className="feedback--btn-close"></button>
               <p>¡Buenas noticias! Tenés un descuento especial por producto combinado y bonificación.</p>
            </div>

            <div className="feedback feedback-success feedback-dismissible">
               <button type="button" className="feedback--btn-close"></button>
               <p>¡Buenas noticias! Tenés un descuento especial por bonificación.</p>
            </div>

            <div className="feedback feedback-success feedback-dismissible">
               <button type="button" className="feedback--btn-close"></button>
               <p>¡Buenas noticias! Tenés un descuento especial por producto combinado.</p>
            </div>
            ...
            <div className="feedback feedback-info feedback-dismissible">
               <button type="button" className="feedback--btn-close"></button>
               <p>This is a info alert with <a href="#" className="feedback-link">an example link</a>.</p>
            </div>
